...
cc.Class({
    ...
    InitDateList: function () {
        ...
        str = str.replace("-", "");
        console.log(str);
        cc.vv.net.send("issuediamondlist", { clubid: this._data.rows[this._curDateArrIndex].clubid, ymd: str, page: 1 });
    },
    ...
    InitDetail: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            item.getChildByName("number").getComponent(cc.Label).string = data[i].gems;
            item.active = true;
        }
