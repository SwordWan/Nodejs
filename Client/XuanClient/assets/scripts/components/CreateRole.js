cc.Class({
    ...
    onRandomBtnClicked:function(){
        ...
        var idx3 = Math.floor(Math.random() * (names.length - 1));
        var idx4 = Math.floor(Math.random() * (names2.length - 1));
        if(Math.random() > 0.7) {
            this.inputName.string = names[idx] + names2[idx2]+ names[idx3]+ names2[idx4];
        }
        else if(Math.random() > 0.4) {
            this.inputName.string = names[idx] + names2[idx2]+ names[idx3];
        }
        else {
